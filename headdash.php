    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown <?php if(@$_GET['q']==6 || @$_GET['q']==7) echo'active'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="headdash.php?q=6">Add Course</a></li>
            <li><a href="headdash.php?q=7">Remove Course</a></li>
          </ul>
        </li>
      </ul> 
          </div><!-- /.navbar-collapse -->
...
$e=$row['userId'];
$s=$row['score'];
$q12=mysqli_query($con,"SELECT * FROM user WHERE userId='$e' " )or die('Error231');
...
while($row = mysqli_fetch_array($result)) {
	...
	<td><a title="Delete User" href="update.php?duid='.$uid.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></td></tr>';
}
$c=0;
echo '</table></div>';
...
echo  '<div class="panel"><table class="table table-striped title1">
<tr><td><b>Name</b></td><td><b>Email</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
  ...
  echo
  '<a title="Delete User" href="update.php?demail1='.$email.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></td></tr>';
  }
}
$c=0;
echo '</table></div>';
...
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Admin Details</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6">   <form class="form-horizontal title1" name="form" action="update.php?addCourse=1"  method="POST">
<fieldset>

<div class="form-group">
  <label class="col-md-12 control-label" for="total"></label>  
  <div class="col-md-12">
  <input id="cid" name="cid" placeholder="Enter Course ID" class="form-control input-md" type="text">
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Enter Course Name" class="form-control input-md" type="text">
...
$result = mysqli_query($con,"SELECT * FROM course") or die('Error');
echo  '<div class="panel"><table class="table table-striped title1">
<tr><td><b>ID</b></td><td><b>Name</b></td><td><b>Password</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
  ...
  echo '<tr><td>'.$cid.'</td><td>'.$name.'</td><td>'.$password.'</td>
  <td>';
  
  echo
  '<a title="Delete User" href="update.php?dcid='.$cid.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></td></tr>';
